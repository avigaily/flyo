<template>
  <div class="home">
    <header class="container-grid">
      <section class="flex space-between align-center header">
        <router-link to="/">
    ...
    <section class="hero">
      <section class="container-grid">
        <section class="flex column align-center hero-content">
          <img alt src="../images/illustration-intro.png" />
          <h2>All your files in one secure location, accessible anywhere.</h2>
          <p>
            Fylo stores all your most important files in one secure location.
            Access them wherever you need, share and collaborate with friends family, and co-workers.
          </p>
          <router-link to="/" class="flex justify-center align-center">Get Started</router-link>
        </section>
      </section>
    </section>
    ...
    <section class="desc-fold flex justify-center align-center">
      <img src="../images/illustration-stay-productive.png" />
      <div class="desc">
        <h2>Stay productive, wherever you are</h2>
        <p>Never let location be an issue when accessing your files. Fylo has you covered for all of your file storage needs.</p>
        <p>Securely share files and folders with friends, family and colleagues for live collaboration. No email attachments required.</p>
        <router-link to="/" class="flex align-center space-between">
          <span>how Fylo works</span>
          <svg
            width="16"
            height="16"
          ...
          >
            <defs>
              ...
              <filter
                ...
                id="a"
              >
                <feDropShadow dx="0" dy="0" stdDeviation="0.8" flood-color="cyan" />
    ...
    <section class="quote-fold container-grid">
      <section class="flex space-around">
        <img alt="quote image" src="../images/bg-quotes.png" />
        <div class="card ">
          <p>Fylo has improved our team productivity by an order of magnitude. Since making the switch our team has become a well-oiled collaboration machine.</p>
          <article>
            <img alt="person picture" src="../images/profile-1.jpg" />
            <h5>Satish Patel</h5>
        ...
        <div class="card">
          <p>Fylo has improved our team productivity by an order of magnitude. Since making the switch our team has become a well-oiled collaboration machine.</p>
          <article>
            <img alt="person picture" src="../images/profile-2.jpg" />
        ...
        <div class="card">
          <p>Fylo has improved our team productivity by an order of magnitude. Since making the switch our team has become a well-oiled collaboration machine.</p>
          <article>
            <img alt="person picture" src="../images/profile-3.jpg" />
            <h5>Iva Boyd</h5>
            <h6>Founder &amp; CEO, Huddle</h6>
          </article>
        </div>
...
<script>
//to deploy npm run gh-pages-deploy
// @ is an alias to /src
export default {
  name: "Home",
  components: {}
